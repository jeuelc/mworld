      ...
      this.OnDragEnd = function(event) {
        ...
        if(position.left < 50 || position.left > 150 || position.top < 220 || position.top > 320) { //balhin na
          if(jid == "polb1") {
            ...
            $('div#polb1 > img').css("-webkit-transform", "rotate(8deg)");
            ...
            $('div#polb2 > img').css("-webkit-transform", "rotate(8deg)");
            ...
            $('div#polb3 > img').css("-webkit-transform", "rotate(8deg)");
            ...
            $('div#polb2 > img').css("-webkit-transform", "rotate(5deg)");
            $('div#polb3 > img').css("-webkit-transform", "rotate(-5deg)");
            $('div#polb4 > img').css("-webkit-transform", "rotate(8deg)");
